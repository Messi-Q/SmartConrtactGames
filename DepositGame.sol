 ...
 * Function destroy() allows the contract owner to destruct the DepositGame contract
 */
contract DepositGame {
    ...
    function destroy() public {
        ...
        if(TotalAmount != 0){
            require(msg.sender.call.value(TotalAmount)(""));  // before selfdestruct, the remained balance will be transferred to the admin
            TotalAmount = 0;
        }
